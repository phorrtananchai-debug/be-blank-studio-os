        ...
        <div className="space-y-3 text-sm text-studio-ink">
          ...
          {payload?.artwork && (
            <>
              ...
              <p className="type-caption">Project: {payload.artwork.projectName || payload.artwork.client || 'Studio'}</p>
          ...
          {!payload?.task && !payload?.document && !payload?.artwork && !payload?.content && (
