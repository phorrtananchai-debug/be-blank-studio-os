...
export function Badge({ children, tone }) {
  ...
  return (
    <span className={`inline-flex min-h-8 shrink-0 items-center whitespace-nowrap rounded-full border px-3.5 text-[11px] font-semibold uppercase leading-none tracking-[0.12em] ${style}`}>
      {children}
    </span>
  );
}
